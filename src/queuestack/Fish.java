...
public class Fish {
    ...
    public static void main(String[] args) {
         ...
         * fish number 2 and eats it, then it meets fish number 3 and eats it too. Finally, it meets fish number 4
         * and is eaten by it. The remaining two fish, number 0 and 4, never meet and therefore stay alive.
         *
         * Write a function:
         *
         ...
         */
        int result = solution(new int[]{0, 1}, new int[]{1, 1});
