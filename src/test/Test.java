...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        int result = solution2(skill, skill_trees);
    ...
    public static int solution(String skill, String[] skill_trees) {
        ...
        for (String skillTree : skill_trees) {
            ...
            for (int i = 0; i < skill.length(); i++) {
                int idxChar = skillTree.indexOf(skill.charAt(i));
                if (idxChar >= 0 && idxOrder < idxChar) {
                    if (isBlank) {
                        isOk = false;
                        break;
                    }
    ...
    public static int solution2(String skill, String[] skill_trees) {
        ...
        while (it.hasNext()) {
            String str = it.next();
            String replaceStr = str.replaceAll("[^" + skill + "]", "");
            System.out.println("######### str: " + str + ", replaceStr: " + replaceStr);
            if (skill.indexOf(replaceStr) != 0) {
                it.remove();
            }
        }
